...
GameBackend = module.exports = (function() {
  ...
  function GameBackend(port, callback) {
    ...
    this.app.get("/assets/api/mocospace.js", function(request, response) {
      response.redirect("http://localhost:3000/assets/api/mocospace.js");
    });
  }
  ...
  GameBackend.prototype.validSignature = function(queryParameters) {
    ...
    text += "secret";
    md5.update(text.toUpperCase());
    var calculatedSignature = md5.digest('hex');
